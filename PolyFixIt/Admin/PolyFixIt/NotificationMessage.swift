...
// MARK: - SwiftUI View (The Dropdown Panel)
...
class NotificationButton: UIBarButtonItem {
    ...
    private let badgeLabel = UILabel() // The Red Circle
    ...
    private func setup() {
        ...
        // 2. Setup Badge Label (Red circle with white text)
        ...
        // Position the badge on top-right of the bell
    ...
    @objc private func togglePanel() {
        ...
        if isPanelVisible {
            ...
            updateBadge(count: 0) // Clear badge when viewed
        }
    ...
    private func fetchNotificationsFromFirebase() {
        ...
        db.collection("notifications")
            ...
            .addSnapshotListener { [weak self] snapshot, error in
                ...
                // Update badge count
                if docs.count > 0 {
                    self.updateBadge(count: docs.count)
                }
    ...
    private func showPanel(in parent: UIViewController) {
        ...
        NSLayoutConstraint.activate([
            ...
            hc.view.trailingAnchor.constraint(equalTo: parent.view.trailingAnchor, constant: -10)
        ])
