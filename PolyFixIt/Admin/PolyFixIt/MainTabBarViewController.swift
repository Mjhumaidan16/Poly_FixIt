...
class MainTabBarViewController: UITabBarController, UITabBarControllerDelegate {
    ...
    @objc private func menuButtonTapped(_ sender: UIButton) {
        ...
        let storyboard = UIStoryboard(name: "Main", bundle: nil)
            ...
            switch sender.tag {
            case 6:
                nextVC = storyboard.instantiateViewController(withIdentifier: "PendingRequestsViewController")
            case 5:
                nextVC = storyboard.instantiateViewController(withIdentifier: "Inventory")
            case 4:
                nextVC = storyboard.instantiateViewController(withIdentifier: "AdminChangePasswordViewController")
            default:
                return
            }
