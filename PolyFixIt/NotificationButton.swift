...
class NotificationButton: UIBarButtonItem {
    ...
    private func setup() {
        triggerButton.setImage(UIImage(systemName: "bell"), for: .normal)
        ...
        db.collection("notifications")
            ...
            .addSnapshotListener { [weak self] snapshot, error in
                ...
                self?.messages = docs.map { doc in
                    let data = doc.data()
                    let title = data["triggeredby"] as? String ?? "System"
                    ...
                    return NotificationMessage(title: title, message: msg, timestamp: timeStr)
                }
    ...
    private func showPanel(in parent: UIViewController) {
        ...
        // تم التعديل هنا: تحديد UIColor بدقة لحل مشكلة 'clear'
